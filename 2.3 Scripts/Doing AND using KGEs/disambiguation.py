# Contains the functions that were
# developed for carrying author name disambiguation by using knowledge graph embeddings.
...
# Used to preliminarily group the authors in the KG into different sub-sets 
# by means of their last name and first initial,
...
# input the output of the do_blocking function and 
# disambiguates the authors by means of Knowledge Graph Embeddings 
